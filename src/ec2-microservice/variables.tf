...
variable "asg_termination_policies" {
  description = "List of policies for scale in policy. Default: [OldestInstance,OldestLaunchTemplate]"
  type        = list(string)
  default = [
    "OldestInstance",
...
variable "asg_instance_refresh_pt" {
  description = "Instance refresh (in percentage) for Rolling update. Default: 50"
  type        = number
  default     = 50
}
